...
namespace Clinic.Migrations
{
    ...
    [Migration("20240913054711_AddBlogCreatedTimestamp")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clinic.Models.Cargo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Clinic.Models.Status", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Clinic.Models.Stock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Clinic.Models.Cargo", b =>
                {
                    b.HasOne("Clinic.Models.Invoice", "Invoice")
                        .WithMany("Cargoes")
            ...
            modelBuilder.Entity("Clinic.Models.Invoice", b =>
                {
                    b.HasOne("Clinic.Models.Stock", "Endpoint")
                        .WithMany("Invoices")
                        .HasForeignKey("EndpointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Clinic.Models.User", "Recipient")
                        .WithMany("ReceiveInvoices")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Clinic.Models.User", "Sender")
                        .WithMany("SendInvoices")
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Clinic.Models.Status", "Status")
                        .WithMany("Invoices")
