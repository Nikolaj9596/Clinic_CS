...
namespace Clinic.Controllers
{
    ...
    public class ClientController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<Results<NotFound, Ok<GetClientDto>>> Show(int id, CancellationToken cancellationToken)
        {
        ...
        [HttpPut("{id}")]
        public async Task<Results<NotFound, Ok<GetClientDto>>> Update(int id, [FromBody] UpdateClientDto client, CancellationToken cancellationToken)
        {
